...
amy.reviews.create(book: Book.third, headline: "A 5 Year Old Know More", text:"Don't even waste your time on this one", rating: 2)
...
sal.reviews.create(book: Book.all[4], headline: "Interiguing", text:"Hmmmm...intersting", rating: 9)
